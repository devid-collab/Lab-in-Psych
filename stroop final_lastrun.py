...
expName = 'stroop final'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/Devidhulesia/Desktop/stroop final_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if intro.status == STARTED:
            ...
            if tThisFlipGlobal > intro.tStartRefresh + 1.0-frameTolerance:
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/Devidhulesia/Desktop/conditions.xlsx'), 
        seed=None, 
    )
